          ...
          <div class="row g-5">
              ...
              <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                  <div class="service-item">
                      ...
                      <p>Nulla facilisi morbi tempus iaculis urna id volutpat lacus laoreet non curabitur gravida
                          arcu.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row justify-content-center">
              <div class="col-lg-8">
                  <div class="intro-content text-center mb-5" data-aos="fade-up" data-aos-delay="150">
                      <p class="lead-text">Expertise refined through years of dedicated practice and continuous
                          learning</p>
                  </div>
              </div>
          </div>
          ...
          <div class="skills-grid">
              <div class="skill-item skills-animation" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <p class="skill-description">Crafting visually compelling designs that communicate effectively
                      and engage users across multiple touchpoints and platforms.</p>
              </div>
              ...
              <div class="skill-item skills-animation" data-aos="fade-up" data-aos-delay="250">
                  ...
                  <p class="skill-description">Building responsive, performant web applications using modern
                      frameworks and following industry best practices for scalability.</p>
              </div>
              ...
              <div class="skill-item skills-animation" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <p class="skill-description">Developing comprehensive digital strategies that align business
                      objectives with user needs and market opportunities.</p>
              </div>
              ...
              <div class="skill-item skills-animation" data-aos="fade-up" data-aos-delay="350">
                  ...
                  <p class="skill-description">Guiding cross-functional teams through complex projects while
                      fostering collaboration and maintaining high standards of quality.</p>
              </div>
              ...
              <div class="skill-item skills-animation" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <p class="skill-description">Identifying emerging trends and technologies to create
                      forward-thinking solutions that push boundaries and exceed expectations.</p>
              </div>
              ...
              <div class="skill-item skills-animation" data-aos="fade-up" data-aos-delay="450">
                  ...
                  <p class="skill-description">Designing robust technical foundations that support scalable
                      growth while maintaining security and performance standards.</p>
              </div>
          </div>
              ...
              <div class="row align-items-center">
                  <div class="col-lg-6">
                      <div class="cert-content">
                          ...
                          <p class="cert-description">Continuous learning and professional development ensure
                              that skills remain current with industry standards and emerging technologies.</p>
                          <div class="cert-list">
                              <div class="cert-item">
                                  <i class="bi bi-award"></i>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row justify-content-center mb-5">
              <div class="col-lg-8 text-center" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <p class="section-description">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
                      posuere cubilia curae; Mauris viverra veniam sit amet lacus cursus.</p>
              </div>
          </div>
                  ...
                  <div class="stats-container">
                      ...
                      <div class="stat-item" data-aos="fade-up" data-aos-delay="100">
                          <div class="stat-content">
                              <div class="stat-number">
                                  <span data-purecounter-start="0" data-purecounter-end="15"
                                      data-purecounter-duration="2" class="purecounter"></span>K+
                              </div>
                              <div class="stat-divider"></div>
                              <div class="stat-label">Global Partners</div>
                              <p class="stat-description">Collaborating with industry leaders worldwide to
                      ...
                      <div class="stat-item" data-aos="fade-up" data-aos-delay="200">
                          <div class="stat-content">
                              ...
                              <p class="stat-description">Consistently achieving outstanding outcomes across all
                      ...
                      <div class="stat-item" data-aos="fade-up" data-aos-delay="300">
                          <div class="stat-content">
                              <div class="stat-number">
                                  <span data-purecounter-start="0" data-purecounter-end="2.8"
                                      data-purecounter-duration="2" class="purecounter"></span>M
                              </div>
                              <div class="stat-divider"></div>
                              <div class="stat-label">Users Served</div>
                              <p class="stat-description">Empowering millions of users with innovative solutions
                                  and seamless experiences.</p>
                          </div>
                      </div>
                          ...
                          <div class="stat-content">
                              <div class="stat-number">
                                  <span data-purecounter-start="0" data-purecounter-end="24"
                                      data-purecounter-duration="2" class="purecounter"></span>/7
                              </div>
                              <div class="stat-divider"></div>
                              <div class="stat-label">Support Available</div>
                              <p class="stat-description">Round-the-clock assistance ensuring uninterrupted
                                  service and peace of mind.</p>
                          </div>
                      </div>
              ...
              <div class="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="500">
                  <div class="achievement-badge">
                      ...
                      <div class="badge-content">
                          ...
                          <p class="badge-text">Awarded "Excellence in Innovation" for three consecutive years by
                              leading industry organizations.</p>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="row gy-4">
              <div class="col-xl-2 col-lg-3 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="100">
                  <div class="client-item">
                      <img src="{{ asset('assets') }}/img/clients/clients-1.webp" class="img-fluid" alt="Client 1">
                  </div>
              </div><!-- End Client Item -->

              <div class="col-xl-2 col-lg-3 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="150">
                  <div class="client-item">
                      <img src="{{ asset('assets') }}/img/clients/clients-2.webp" class="img-fluid" alt="Client 2">
                  </div>
              </div><!-- End Client Item -->

              <div class="col-xl-2 col-lg-3 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="200">
                  <div class="client-item">
                      <img src="{{ asset('assets') }}/img/clients/clients-3.webp" class="img-fluid" alt="Client 3">
                  </div>
              </div><!-- End Client Item -->

              <div class="col-xl-2 col-lg-3 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="250">
                  <div class="client-item">
                      <img src="{{ asset('assets') }}/img/clients/clients-4.webp" class="img-fluid" alt="Client 4">
                  </div>
              </div><!-- End Client Item -->

              <div class="col-xl-2 col-lg-3 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="300">
                  <div class="client-item">
                      <img src="{{ asset('assets') }}/img/clients/clients-5.webp" class="img-fluid" alt="Client 5">
                  </div>
              </div><!-- End Client Item -->

              <div class="col-xl-2 col-lg-3 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="350">
                  <div class="client-item">
                      <img src="{{ asset('assets') }}/img/clients/clients-6.webp" class="img-fluid" alt="Client 6">
                  </div>
              </div><!-- End Client Item -->
          ...
          <div class="row gy-5">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                  <div class="service-item">
                      ...
                      <h3>Web Development</h3>
                      <p>Crafting responsive, modern websites that deliver exceptional user experiences and drive
                          business growth.</p>
                      <a href="service-details.html" class="service-link">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="250">
                  <div class="service-item">
                      ...
                      <h3>Brand Design</h3>
                      <p>Creating compelling visual identities that communicate your brand's essence and resonate
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                  <div class="service-item">
                      ...
                      <h3>Digital Marketing</h3>
                      <p>Strategic marketing solutions that amplify your reach and convert prospects into loyal
                          customers.</p>
                      <a href="service-details.html" class="service-link">
                          <span>Learn More</span>
                          <i class="bi bi-arrow-right"></i>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                  <div class="service-item">
                      ...
                      <h3>Mobile Apps</h3>
                      <p>Native and cross-platform mobile applications that provide seamless functionality across
                          all devices.</p>
                      <a href="service-details.html" class="service-link">
                          <span>Learn More</span>
                          <i class="bi bi-arrow-right"></i>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="250">
                  <div class="service-item">
                      ...
                      <h3>Cybersecurity</h3>
                      <p>Comprehensive security solutions to protect your digital assets and maintain customer
                          trust.</p>
                      <a href="service-details.html" class="service-link">
                          <span>Learn More</span>
                          <i class="bi bi-arrow-right"></i>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                  <div class="service-item">
                      ...
                      <h3>Consulting</h3>
                      <p>Expert guidance and strategic insights to optimize your business processes and achieve
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                      <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="200">
                          <div class="testimonial-header">
                              <img src="{{ asset('assets') }}/img/person/person-f-12.webp" alt="Client"
                  ...
                  <div class="swiper-slide">
                      <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="400">
                          <div class="testimonial-header">
                              <img src="{{ asset('assets') }}/img/person/person-f-6.webp" alt="Client"
                                  class="img-fluid" loading="lazy">
                              <div class="rating">
                                  <i class="bi bi-star-fill"></i>
                                  <i class="bi bi-star-fill"></i>
                  ...
                  <div class="swiper-slide">
                      <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="500">
                          <div class="testimonial-header">
                              <img src="{{ asset('assets') }}/img/person/person-m-12.webp" alt="Client"
                                  class="img-fluid" loading="lazy">
                              <div class="rating">
                                  <i class="bi bi-star-fill"></i>
                                  <i class="bi bi-star-fill"></i>
                  ...
                  <div class="swiper-slide">
                      <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="600">
                          <div class="testimonial-header">
                              <img src="{{ asset('assets') }}/img/person/person-f-10.webp" alt="Client"
                                  class="img-fluid" loading="lazy">
                              <div class="rating">
                                  <i class="bi bi-star-fill"></i>
                                  <i class="bi bi-star-fill"></i>
          ...
          <div class="isotope-layout" data-default-filter="*" data-layout="fitRows" data-sort="original-order">
              ...
              <div class="row gy-4 portfolio-grid isotope-container" data-aos="fade-up" data-aos-delay="200">
                      ...
                      <div class="portfolio-card">
                          <div class="image-container">
                              <img src="{{ asset('assets') }}/img/portfolio/portfolio-3.webp" class="img-fluid"
                                  alt="Brand Identity" loading="lazy">
                              <div class="overlay">
                                  <div class="overlay-content">
                                      <a href="{{ asset('assets') }}/img/portfolio/portfolio-3.webp"
                                          class="glightbox zoom-link" title="Brand Identity Project">
                  ...
                  <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-print">
                      <div class="portfolio-card">
                          <div class="image-container">
                              <img src="{{ asset('assets') }}/img/portfolio/portfolio-portrait-5.webp"
                                  class="img-fluid" alt="Magazine Design" loading="lazy">
                              <div class="overlay">
                                  <div class="overlay-content">
                                      <a href="{{ asset('assets') }}/img/portfolio/portfolio-portrait-5.webp"
                      ...
                      <div class="portfolio-card">
                          <div class="image-container">
                              <img src="{{ asset('assets') }}/img/portfolio/portfolio-8.webp" class="img-fluid"
                                  alt="Motion Graphics" loading="lazy">
                              <div class="overlay">
                                  <div class="overlay-content">
                                      <a href="{{ asset('assets') }}/img/portfolio/portfolio-8.webp"
                      ...
                      <div class="portfolio-card">
                          <div class="image-container">
                              <img src="{{ asset('assets') }}/img/portfolio/portfolio-9.webp" class="img-fluid"
                                  alt="Logo Collection" loading="lazy">
                              <div class="overlay">
                                  <div class="overlay-content">
                                      <a href="{{ asset('assets') }}/img/portfolio/portfolio-9.webp"
                  ...
                  <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                      <div class="portfolio-card">
                          <div class="image-container">
                              <img src="{{ asset('assets') }}/img/portfolio/portfolio-portrait-8.webp"
                                  class="img-fluid" alt="Mobile App Design" loading="lazy">
                              <div class="overlay">
                                  <div class="overlay-content">
                                      <a href="{{ asset('assets') }}/img/portfolio/portfolio-portrait-8.webp"
                      ...
                      <div class="portfolio-card">
                          <div class="image-container">
                              <img src="{{ asset('assets') }}/img/portfolio/portfolio-10.webp" class="img-fluid"
                                  alt="Packaging Design" loading="lazy">
                              <div class="overlay">
                                  <div class="overlay-content">
                      ...
                      <div class="portfolio-card">
                          <div class="image-container">
                              <img src="{{ asset('assets') }}/img/portfolio/portfolio-11.webp" class="img-fluid"
                                  alt="Brand Animation" loading="lazy">
                              <div class="overlay">
                                  <div class="overlay-content">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row gy-4">
              ...
              <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                  <div class="member-card">
                      <div class="member-image-wrapper">
                          <img src="{{ asset('assets') }}/img/person/person-f-1.webp" class="img-fluid"
                              alt="Team Member">
                      </div>
                      <div class="member-content">
                          <h4 class="member-name">Sarah Chen</h4>
                          <span class="member-role">Chief Executive Officer</span>
                          <p class="member-bio">Praesentium nihil ut laudantium cumque. Ut et consequatur ab ut
              ...
              <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                  <div class="member-card">
                      <div class="member-image-wrapper">
                          <img src="{{ asset('assets') }}/img/person/person-m-2.webp" class="img-fluid"
                              alt="Team Member">
                      </div>
                      <div class="member-content">
                          <h4 class="member-name">David Lee</h4>
                          <span class="member-role">Product Manager</span>
                          <p class="member-bio">Voluptas qui enim omnis est atque. Enim sunt quo et amet corporis
                              et. Autem eaque optio.</p>
                          <div class="member-socials">
                              <a href="#"><i class="bi bi-twitter-x"></i></a>
                              <a href="#"><i class="bi bi-facebook"></i></a>
                              <a href="#"><i class="bi bi-linkedin"></i></a>
              ...
              <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                  <div class="member-card">
                      <div class="member-image-wrapper">
                          <img src="{{ asset('assets') }}/img/person/person-f-3.webp" class="img-fluid"
                              alt="Team Member">
                      </div>
                      <div class="member-content">
              ...
              <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                  <div class="member-card">
                      <div class="member-image-wrapper">
                          <img src="{{ asset('assets') }}/img/person/person-m-4.webp" class="img-fluid"
                              alt="Team Member">
                      </div>
                      <div class="member-content">
  ...
  <section id="pricing" class="pricing section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="pricing-toggle-container mb-5" data-aos="zoom-in" data-aos-delay="150">
              ...
              <p class="hint mt-3 mb-0 small">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do
                  eiusmod tempor.</p>
          </div>
              ...
              <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                  <article class="price-card h-100">
                      <div class="card-head">
                          ...
                          <p class="subtitle">Quis autem vel eum iure reprehenderit qui in ea voluptate velit
                              esse.</p>
                          <div class="price-wrap">
